...
import { Factory as FactoryIcon, Code } from "lucide-react";
import { TiInputChecked } from "react-icons/ti";
import useContent from "@/hooks/useContent";


const iconMap = {
  Factory: <FactoryIcon className="text-purple-600 dark:text-purple-300" size={24} />,
  Code: <Code className="text-green-600 dark:text-green-300" size={24} />
};

const Factory = () => {
  const { data: cards, loading, error } = useContent("factoryMethods");
